...
Health check: `curl http://127.0.0.1:5000/health` · UI: `http://localhost:5000`
...
*Dla rekruterów: produkcyjny RAG z weryfikacją 2× LLM, Qdrant, wieloma trybami analizy i grafem powiązań — nie tutorial.*
